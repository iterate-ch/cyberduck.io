...
<p><q cite="Comment to macworld.com article">
					Nice article, but I don&apos;t use any those. I have found Cyberduck to totally and wonderfully take care of my FTP needs. It&apos;s just free and works great. I like the way it handles accounts too. It&apos;s interface is clean and easy to navigate. I give it 5 mouses.
				</q></p>
				...
				<p><q cite="mac.dtgeeks.com">There are a number of FTP clients out for Mac OS X, ranging from (...). However, there is one FTP client that stands out. It’s free, it’s excellent, and it has a great name: Cyberduck! Cyberduck sports most of the features you’d expect from an FTP client, such as bookmarks, SFTP, the ability to toggle transfer modes, synchonization and so forth.</q></p>
				...
				<p><q cite="boingboing.net">I've been using David Kocher's Cyberduck FTP client for several months now. (...) All the other FTP clients I've used have been hard to learn and are confusing, but I've never had to look at the help file for Cyberduck. I don't even know if it has a help file. The bookmarking feature is well-implemented and I like being able to click on the BBEdit icon to edit any file on the server. (...) If you are looking for a simple, power FTP client, check this out.
								</q></p>
				<p><q cite="mactouch.com">Nombreux sont ceux qui ont besoin d’un client FTP (pour mettre à jour leur site perso par exemple). Les noms qui viennent immédiatement à l’esprit sont (...). Mais Cyberduck, qui existe depuis plus d’un an dans sa version Cocoa, vient les concurrencer.
								</q></p>
				<p><q cite="macreviewzone.com">It might lack the cachet of (...), but when it comes to FTP, David Kocher's open-source Cyberduck should be taken seriously. (...) Cyberduck is a robust FTP and SFTP application whose lack of visual clutter and cleverly intuitive features make it easy to use.
								</q></p>
