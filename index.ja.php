				...
				<div class="box-shadow">
					<div id="mac" class="download">
						<div>
							...
							<strong>バージョン4.1.3</strong><br />
							<em>Sep-28-2011</em><br />
							<a href="Cyberduck-4.1.3.zip" onClick="javascript:_gaq.push(['_trackEvent', 'Downloads', '*.zip', '/Cyberduck-4.1.3.zip']);">Cyberduck-4.1.3.zip</a><br />
					...
					<div id="windows" class="download">
						<div>
							<strong>バージョン4.1.3</strong><br />
							<em>Sep-28-2011</em><br />
							<a href="windows/Cyberduck-Installer-4.1.3.exe" onClick="javascript:_gaq.push(['_trackEvent', 'Downloads', '*.exe', '/Cyberduck-Installer-4.1.3.exe']);">Cyberduck-Installer-4.1.3.exe</a><br />
