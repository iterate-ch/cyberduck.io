				...
				<div class="box-shadow">
					<div id="mac" class="download">
						<div>
							...
							<strong>バージョン4.1.1</strong><br />
							<em>Aug-29-2011</em><br />
							<a href="Cyberduck-4.1.1.zip" onClick="javascript:_gaq.push(['_trackEvent', 'Downloads', '*.zip', '/Cyberduck-4.1.1.zip']);">Cyberduck-4.1.1.zip</a><br />
					...
					<div id="windows" class="download">
						<div>
							<strong>バージョン4.1.1</strong><br />
							<em>2011年3月24日</em><br />
							<a href="windows/Cyberduck-Installer-4.1.1.exe" onClick="javascript:_gaq.push(['_trackEvent', 'Downloads', '*.exe', '/Cyberduck-Installer-4.1.1.exe']);">Cyberduck-Installer-4.1.1.exe</a><br />
