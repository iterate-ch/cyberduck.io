				...
				<div id="features">
					...
					<div class="description">
						...
						<div class="column">
							...
							<div class="feature">
								<p><img src="http://media.cyberduck.ch/img/google.png" class="feature" alt="" /> <strong>Google Cloud Storage</strong><br />認証付きURLを備えたACLを使用してファイルへのアクセス権を付与し、安全にファイルを共有できます。</p>
							</div>
							<div class="feature">
