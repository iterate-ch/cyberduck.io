...
<body id="index">
	...
	<div id="container">
		<div id="maincolumn">
			...
			<div id="content">
				<div id="features">
					<img src="http://cdn.cyberduck.ch/img/connect.png" class="headline" />
					...
					<div id="screenshots">
						<div class="figure">
							<a class="windows" style="display:none;" href="http://cdn.cyberduck.ch/img/windows/browser-bookmarks.png"><img alt="Cyberduck Bookmarks" width="400px" src="http://cdn.cyberduck.ch/img/windows/browser-bookmarks-thumb.png" /></a>
							<a class="mac" style="display:none;" href="http://cdn.cyberduck.ch/img/mac/browser-bookmarks.png"><img alt="Cyberduck Bookmarks" width="400px" src="http://cdn.cyberduck.ch/img/mac/browser-bookmarks-thumb.png" /></a>

							<p>ブックマーク</p>
						</div>

						<div class="figure">
							<a class="windows" style="display:none;" href="http://cdn.cyberduck.ch/img/windows/browser.png"><img alt="Cyberduck Browser" width="400px" src="http://cdn.cyberduck.ch/img/windows/browser-thumb.png" /></a>
							<a class="mac" style="display:none;" href="http://cdn.cyberduck.ch/img/mac/browser.png"><img alt="Cyberduck Browser" width="400px" src="http://cdn.cyberduck.ch/img/mac/browser-thumb.png" /></a>
					...
					<img src="http://cdn.cyberduck.ch/img/pencil.png" class="headline" />
					<div class="description">
					...
					<img src="http://cdn.cyberduck.ch/img/cf-disk.png" class="headline" />
					<div class="description">
					...
					<img src="http://cdn.cyberduck.ch/img/s3-disk.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/s3.png" class="feature" alt="" /> <strong>バージョニングとMFA</strong><br />
							...
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/info.png" class="feature" alt="" /> <strong>メタデータ</strong><br />
									ファイルの標準HTTPヘッダを編集、またはカスタムHTTPヘッダを追加して、メタデータの格納やキャッシュ有効期限の設定が可能。バッチ編集にも対応。</p>
							</div>
						</div>
					</div>
				
					<img src="http://cdn.cyberduck.ch/img/google-disk.png" class="headline" />
					<div class="description">
						<h2 class="headline">Google Docsを管理。</h2>
						<p>Google Docs形式に変換してアップロード。画像はOCR（光学式文字認識）されます。</p>
					</div>
				
					<img src="http://cdn.cyberduck.ch/img/bookmark.png" class="headline" />
					<div class="description">
						<h2 class="headline">最上級のブックマーク。</h2>
						<p>ドラッグ&ドロップでブックマークを管理、フィルタフィールドを使って素早く検索。</p>
						<div class="column">
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/document.png" class="feature" alt="" /> <strong>ファイル</strong><br />
							...
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/history.png" class="feature" alt="" /> <strong>履歴</strong><br />
								訪問したサーバの履歴を保存。</p>
							...
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/advanced.png" class="feature" alt="" /> <strong>インポート</strong><br />
							 サードパーティのアプリケーションから <a href="http://trac.cyberduck.ch/wiki/help/en/howto/bookmarks#Fromthird-partyapplications">ブックマークをインポート</a>。
							</div>
						</div>
					</div>

					<img src="http://cdn.cyberduck.ch/img/browse.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							...
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/outline.png" class="feature" alt="" /> <strong>使いやすく</strong><br />
					...
					<img src="http://cdn.cyberduck.ch/img/transfer.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/download.png" class="feature" alt="" /> <strong>ダウンロードとアップロード</strong><br />
								ブラウザからブラウザへドラッグ&ドロップするだけで、サーバ間のファイルダウンロードやアップロード、コピーができます。とても簡単です。</p>
							</div>
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/sync.png" class="feature" alt="" /> <strong>同期</strong><br />
					...
					<img src="http://cdn.cyberduck.ch/img/sftp-disk.png" class="headline" />
					<div class="description">
						<h2 class="headline">高度なSSH機能。</h2>
						<p>至れり尽くせり、妥協のない<a href="http://trac.cyberduck.ch/wiki/help/en/howto/sftp">SFTP</a>サーバアクセス。</p>
						<div class="column">
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/protocol.png" class="feature" alt="" /> <strong>認証とセキュリティ</strong><br />
公開鍵認証、キーボードインタラクティブ（PAM）認証、ワンタイムパスワードに対応。多様な暗号化方式（3DES、Blowfish、Twofish、AES、CAST）と認証アルゴリズムをサポート。任意でSecure Copy（SCP）を使用したファイル転送も可能。</p>
							...
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/openssh.png" class="feature" alt="" /><strong>相互運用性</strong><br />
							...
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/archive.png" class="feature" alt="" /><strong>アーカイブ</strong><br />
								SSH経由のリモートで、TARおよびZIPファイルを圧縮、展開。</p>
							</div>
						</div>
					</div>
				
					<img src="http://cdn.cyberduck.ch/img/mac32.png" class="headline" />
					<div class="description">
						<h2 class="headline">システムテクノロジーとの統合。</h2>
						<p>Mac OS XでもWindowsでもネイティブ。</p>
						<div class="column">
							<div class="feature">
								<p><img src="http://cdn.cyberduck.ch/img/keychain.png" class="feature" alt="" /> <strong>キーチェーン</strong><br />
					...
					<img src="http://cdn.cyberduck.ch/img/osi.png" class="headline" />
					<div class="description">
					...
					<img src="http://cdn.cyberduck.ch/img/language.png" class="headline" />
					<div class="description">
		...
		<div id="sidebar">
			<div id="teaser">
				...
				<div class="box-shadow">
					<div id="mac" class="download">
						...
						<img src="http://cdn.cyberduck.ch/img/mac32.png" />
					</div>
					...
					<div id="windows" class="download">
						...
						<img src="http://cdn.cyberduck.ch/img/windows32.png" />
					</div>
					<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
						<input type="hidden" name="cmd" value="_s-xclick" />
						<input type="hidden" id="paypal" name="hosted_button_id" value="4914397" />
						<input type="image" src="https://www.paypal.com/ja_JP/JP/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="寄付する" />
			...
			<div class="box-solid">
				...
				<p><img class="feature" src="http://cdn.cyberduck.ch/img/feed-icon-16x16.png" alt="feed" /><strong>ブログ</strong> <a class="ext" href="news">開発ブログ</a> を <a class="ext" href="http://cyberduck.ch/changelog.rss">購読</a>。</p>
				<p><img class="feature" src="http://cdn.cyberduck.ch/img/twitter.png" alt="twitter" /> <strong>Twitter</strong> <a class="ext" href="http://twitter.com/davidkocher">@davidkocherをフォロー</a>。</p>
