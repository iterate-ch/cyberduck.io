			...
			<div id="content">
				<div id="features">
					...
					<div id="screenshots" class="showcase">
						<div>
							<img src="http://g.cyberduck.ch/img/mac/browser-bookmarks.png" width="600px" alt="01" />
						...
						<div>
							<img src="http://g.cyberduck.ch/img/mac/browser.png" width="600px" alt="02" />
							<div class="showcase-thumbnail">
						...
						<div>
							<img src="http://g.cyberduck.ch/img/windows/browser-bookmarks.png" width="600px" alt="03" />
							<div class="showcase-thumbnail">
						...
						<div>
							<img src="http://g.cyberduck.ch/img/windows/browser.png" width="600px" alt="04" />
							<div class="showcase-thumbnail">
					...
					<div class="description">
						...
						<div class="column">
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/google.png" class="feature" alt="" /> <strong>Google Storage for Developers</strong><br />認証付きURLを備えたACLを使用してファイルへのアクセス権を付与し、安全にファイルを共有できます。</p>
							</div>
							<div class="feature">
					...
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/s3.png" class="feature" alt="" /> <strong>バージョニングとMFA</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/info.png" class="feature" alt="" /> <strong>メタデータ</strong><br />
					...
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/document.png" class="feature" alt="" /> <strong>ファイル</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/history.png" class="feature" alt="" /> <strong>履歴</strong><br />
								訪問したサーバの履歴を保存。</p>
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/advanced.png" class="feature" alt="" /> <strong>インポート</strong><br />
					...
					<div class="description">
						...
						<div class="column">
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/outline.png" class="feature" alt="" /> <strong>使いやすく</strong><br />
					...
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/download.png" class="feature" alt="" /> <strong>ダウンロードとアップロード</strong><br />
								ブラウザからブラウザへドラッグ&ドロップするだけで、サーバ間のファイルダウンロードやアップロード、コピーができます。とても簡単です。</p>
							</div>
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/sync.png" class="feature" alt="" /> <strong>同期</strong><br />
					...
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/protocol.png" class="feature" alt="" /> <strong>認証とセキュリティ</strong><br />
公開鍵認証、キーボードインタラクティブ（PAM）認証、ワンタイムパスワードに対応。多様な暗号化方式（3DES、Blowfish、Twofish、AES、CAST）と認証アルゴリズムをサポート。任意でSecure Copy（SCP）を使用したファイル転送も可能。</p>
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/openssh.png" class="feature" alt="" /><strong>相互運用性</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/archive.png" class="feature" alt="" /><strong>アーカイブ</strong><br />
					...
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/keychain.png" class="feature" alt="" /> <strong>キーチェーン</strong><br />
