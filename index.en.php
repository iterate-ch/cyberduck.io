...
<head>
	...
	<link rel="stylesheet" href="http://g.cyberduck.ch/style.aw-showcase.css" />
	<script type="text/javascript" src="http://g.cyberduck.ch/jquery.aw-showcase.min.js"></script>
...
<body id="index">
	...
	<div id="container">
		<div id="maincolumn">
			...
			<div id="content">
				<div id="features">
					<img src="http://g.cyberduck.ch/img/connect.png" alt="" class="headline" />
					<div class="description" style="padding-right:40px">
						...
						<div class="column">
							<div class="feature-50">
								<p><img src="http://g.cyberduck.ch/img/openstack.png" class="feature" alt="" /> <strong>Emerging open cloud software standards.</strong><br />Works with thirdparty providers using either the S3 or  Openstack APIs.</p>
							</div>
							<div class="feature-50">
								<p><img src="http://g.cyberduck.ch/img/ftp.png" class="feature" alt="" /> <strong>FTP Core</strong><br />A widely tested <a href="http://trac.cyberduck.ch/wiki/help/en/howto/ftp">FTP (File Transfer Protocol)</a> implementation for the best interoperability with support for FTP over secured SSL/TLS connections.</p>
							</div>
						</div>
					</div>
					...
					<div id="screenshots" class="showcase">
						<div>
							<img src="http://g.cyberduck.ch/img/mac/browser-bookmarks.png" width="600px" alt="Bookmarks" />
							<div class="showcase-thumbnail">
								<img src="http://g.cyberduck.ch/img/mac/browser-bookmarks-thumb.png" alt="01" width="140px" />
								<div class="showcase-thumbnail-cover"></div>
							</div>
						</div>
						<div>
							<img src="http://g.cyberduck.ch/img/mac/browser.png" width="600px" alt="Browser" />
							<div class="showcase-thumbnail">
								<img src="http://g.cyberduck.ch/img/mac/browser-thumb.png" alt="01" width="140px" />
								<div class="showcase-thumbnail-cover"></div>
							</div>
						</div>
						<div>
							<img src="http://g.cyberduck.ch/img/windows/browser-bookmarks.png" width="600px" alt="Bookmarks" />
							<div class="showcase-thumbnail">
								<img src="http://g.cyberduck.ch/img/windows/browser-bookmarks-thumb.png" alt="01" width="140px" />
								<div class="showcase-thumbnail-cover"></div>
							</div>
						</div>
						<div>
							<img src="http://g.cyberduck.ch/img/windows/browser.png" width="600px" alt="Browser" />
							<div class="showcase-thumbnail">
								<img src="http://g.cyberduck.ch/img/windows/browser-thumb.png" alt="01" width="140px" />
								<div class="showcase-thumbnail-cover"></div>
							</div>
						</div>
					</div>
					...
					<img alt="" src="http://g.cyberduck.ch/img/pencil.png" class="headline" />
					...
					<img alt="" src="http://g.cyberduck.ch/img/cf-disk.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/s3.png" class="feature" alt="" /> <strong>Amazon CloudFront</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/google.png" class="feature" alt="" /> <strong>Google Storage for Developers</strong><br />Grant access to files using ACLs with an authenticated URL to share files with securely.</p>
							</div>
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/cf.png" class="feature" alt="" /> <strong>Rackspace Cloud Files</strong><br />
					...
					<img alt="" src="http://g.cyberduck.ch/img/s3-disk.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/s3.png" class="feature" alt="" /> <strong>Versioning and MFA</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/permissions.png" class="feature" alt="" /> <strong>ACL</strong><br />
								Configure Access Control Lists (ACLs) for fine grained access permissions. Copy a signed URL for temporary access.</p>
							</div>
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/info.png" class="feature" alt="" /> <strong>Metadata</strong><br />
					...
					<img alt="" src="http://g.cyberduck.ch/img/google-disk.png" class="headline" />
					<div class="description">
					...
					<img alt="" src="http://g.cyberduck.ch/img/bookmark.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/document.png" class="feature" alt="" /> <strong>Files</strong><br />
								Drag and drop bookmarks to the Finder.app and drop files onto bookmarks to upload.</p>
								<p><img src="http://g.cyberduck.ch/img/spotlight.png" class="feature" alt="" /> <strong>Spotlight</strong><br />
								<a href="http://trac.cyberduck.ch/wiki/help/en/howto/spotlight">Spotlight</a> Importer for bookmark files.</p>
							</div>
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/history.png" class="feature" alt="" /> <strong>History</strong><br />
								History of visited servers with timestamp of last access.</p>
								<p><img src="http://g.cyberduck.ch/img/rendezvous.png" class="feature" alt="" /> <strong>Bonjour</strong><br />
								Auto discovery of FTP &amp; WebDAV services on the local network.</p>
							</div>
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/advanced.png" class="feature" alt="" /> <strong>Import</strong><br />
					...
					<img alt="" src="http://g.cyberduck.ch/img/browse.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/quicklook.png" class="feature" alt="" /> <strong>Quick Look</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/outline.png" class="feature" alt="" /> <strong>Accessible</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/safari.png" class="feature" alt="" /> <strong>Web URL</strong><br />
					...
					<img alt="" src="http://g.cyberduck.ch/img/transfer.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/download.png" class="feature" alt="" /> <strong>Download and Upload</strong><br />
								Drag and drop to and from the browser to download and upload or copy files between servers. No hassle.</p>
							</div>
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/sync.png" class="feature" alt="" /> <strong>Synchronization</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/growl.png" class="feature" alt="" /> <strong>Growl</strong><br />
					...
					<img alt="" src="http://g.cyberduck.ch/img/sftp-disk.png" class="headline" />
					<div class="description">
						...
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/protocol.png" class="feature" alt="" /> <strong>Authentication and security</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/openssh.png" class="feature" alt="" /><strong>Interoperability</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/archive.png" class="feature" alt="" /><strong>Archives</strong><br />
								Archive and expand TAR, ZIP files remotely over SSH.</p>
							</div>
						</div>
					</div>
				
					<img alt="" src="http://g.cyberduck.ch/img/mac32.png" class="headline" />
					<div class="description">
						<h2 class="headline">Integration with system technologies.</h2>
						<p>A native citizen of Mac OS X and Windows.</p>
						<div class="column">
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/keychain.png" class="feature" alt="" /> <strong>Keychain</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/finder.png" class="feature" alt="" /> <strong>Finder</strong><br />
							...
							<div class="feature">
								<p><img src="http://g.cyberduck.ch/img/windows32.png" class="feature" alt="" /> <strong>Windows</strong><br />
					...
					<img alt="" src="http://g.cyberduck.ch/img/osi.png" class="headline" />
					<div class="description">
				...
				<p><small>This product includes software developed by 
					...
					<strong>M. Uli Kusterer</strong> (<a class="ext" href="http://zathras.de/">UKCrashReporter</a>), 
			...
			<div id="teaser">
				...
				<div class="box-shadow">
					<div id="mac" class="download">
						<div>
							<strong>Download<br />Version 4.1.2</strong><br />
							<em>Aug-31-2011</em><br />
							<a href="Cyberduck-4.1.2.zip" onClick="javascript:_gaq.push(['_trackEvent', 'Downloads', '*.zip', '/Cyberduck-4.1.2.zip']);">Cyberduck-4.1.2.zip</a><br />
							<em>Universal Binary. Mac OS X 10.5 or later required. Works with 10.7 Lion.</em>
						</div>
						<img alt="" src="http://g.cyberduck.ch/img/mac32.png" />
					</div>

					<div id="windows" class="download">
						<div>
							<strong>Version 4.1.2</strong><br />
							<em>Aug-31-2011</em><br />
							<a href="windows/Cyberduck-Installer-4.1.2.exe" onClick="javascript:_gaq.push(['_trackEvent', 'Downloads', '*.exe', '/Cyberduck-Installer-4.1.2.exe']);">Cyberduck-Installer-4.1.2.exe</a><br />
						...
						<img alt="" src="http://g.cyberduck.ch/img/windows32.png" />
					</div>
				...
				<p>
					<div align="center">
						<img src="http://g.cyberduck.ch/img/macworld.png" alt="" />
					</div>
				</p>
				<p />
				<p>
					<div align="center">
						<img src="http://g.cyberduck.ch/img/editorschoice.png" alt="" />
					</div>
				</p>
				<p />
				<p>
					<div align="center">
						<img src="http://g.cyberduck.ch/img/pcadvisor.png" alt="" />
					</div>
				</p>
			</div>
		</div>
