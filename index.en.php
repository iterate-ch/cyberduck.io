					...
					<div class="description" style="padding-right:40px">
						...
						<div class="column">
							<div class="feature-50">
								<p><img src="http://media.cyberduck.ch/img/openstack.png" class="feature" alt="" /> <strong>Emerging open cloud software standards.</strong><br />Works with thirdparty providers using either the S3 or  Openstack APIs.</p>
							</div>
							<div class="feature-50">
								<p><img src="http://media.cyberduck.ch/img/ftp.png" class="feature" alt="" /> <strong>FTP Core</strong><br />A widely tested <a href="http://trac.cyberduck.ch/wiki/help/en/howto/ftp">FTP (File Transfer Protocol)</a> implementation for the best interoperability with support for FTP over secured SSL/TLS connections.</p>
							</div>
						</div>
					</div>
