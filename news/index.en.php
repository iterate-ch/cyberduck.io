		...
		<div id="sidebar">
			<div id="teaser">
				...
				<div class="box-shadow">
					...
					<br />
					<p><img src="http://g.cyberduck.ch/img/feed-icon-16x16.png" alt="feed" /> <a href="http://cyberduck.ch/changelog.rss">Subscribe to the RSS feed.</a></p>
					<p><img src="http://g.cyberduck.ch/img/twitter.png" alt="twitter" /> <a href="http://twitter.com/cyberduckapp">Follow @cyberduckapp</a>.</p>
					<br />
					<p>Subscribe to the <a href="http://lists.cyberduck.ch/mailman/listinfo/cyberduck-news">news</a> mailing list to get emails about the latest updates.</p>
					...
					<p>Subscribe to the <a href="http://groups.google.com/group/cyberduck">users</a> group to discuss features and issues you are having.
						<a href="http://groups.google.com/group/cyberduck"><img src="http://g.cyberduck.ch/img/groups.png" height="30" width="140" alt="Google Groups" /></a>
					</p>
