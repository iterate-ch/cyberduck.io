...
<head>
	<?php echo(echoheader("..")); ?>
	<link rel="Stylesheet" type="text/css" href="http://g.cyberduck.ch/news.css" />
	<?php
		...
		<div id="sidebar">
			<div id="teaser">
				...
				<div class="box-shadow">
					...
					<p><img src="http://g.cyberduck.ch/img/twitter.png" alt="twitter" /> <a href="http://twitter.com/cyberduckapp">@cyberduckappをフォロー</a>。</p>
					<br />
