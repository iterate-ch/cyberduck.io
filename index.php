        ...
        <table border="0" cellpadding="5" cellspacing="5" width="700">
            ...
            <tr>
                <td width="200" colspan="2" valign="middle" class="box-solid">
                    ...
                    <p><em>"There are a few free FTP clients for the Mac, but none is as polished or as easy to use as Cyberduck."</em>(<a href="http://www.macworld.com/2004/10/features/bargainsweb/index.php">macworld.com</a>)</p>
                    <div align="center">
                ...
                <td width="100%" bgcolor="#FFFFFF" valign="top" class="box-dash">
                    ...
                    I appreciate any comments, feature suggestions and bug reports.</p>
                </td>
            </tr><!-- ======= Screenshot ======== -->
            <tr>
                <td colspan="3">
                    <div align="center" id="image">
                        <a href="./img/browser.jpg"><img align="middle" width="700" height="454" border="0" src="./img/browser.thumb.jpg" alt="Cyberduck Screenshot" /></a>
                    </div>
                </td>
            </tr><!-- ======= Donate! ======== -->
            ...
            <tr>
                <td width="200" colspan="2" valign="middle" class="box-solid">
                    <div align="center" id="image">
                        <a href="http://www.cafeshops.com/cyberduck"><img src="img/store.jpg" width="128" height="128" align="middle" alt="Shop Cyberduck Gadgets" border="0" /></a>
                    </div>
                </td>
                <td width="100%" bgcolor="#FFFFFF" valign="top" class="box-dash">
            ...
            <tr>
                <td width="200" colspan="2" valign="middle" class="box-solid">
                    <div align="center">
                        <img src="img/x.gif" alt="Built for Mac OS X" border="0" /> <img src="img/macos.gif" alt="Built for Mac OS X" border="0" />
                    </div>
                </td>
            ...
            <tr>
                ...
                <td width="100%" bgcolor="#FFFFFF" valign="top" class="box-dash">
                    <p>You can subscribe to the <a href="http://lists.cyberduck.ch/mailman/listinfo/cyberduck-news">Cyberduck-news</a> mailing list to get a notification when a new version is released.</p>
                    <form method="post" action="http://lists.cyberduck.ch/mailman/subscribe/cyberduck-news">
                        <p>Your email address: <input type="text" name="email" size="30" value="" /> <input type="submit" name="email-button" value="Subscribe" /></p>
                    </form>
                </td>
            </tr>
            <tr>
