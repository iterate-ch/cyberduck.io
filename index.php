			...
			<tr>
				<td>
					...
					<div id="maincolumn" class="box-filled">
						<p class="lead"><strong>Cyberduck is an <a class="ext" href="http://opensource.org/docs/definition.php">open source</a> FTP, SFTP, <span class="version3">WebDAV</span>,
						<a class="ext" href="http://www.rackspacecloud.com/cloud_hosting_products/files">Cloud Files</a> and <span class="version3"><a class="ext" href=
						"http://aws.amazon.com/s3">Amazon S3</a></span> browser for the Mac.</strong> It features an easy to use interface with quickly accessible bookmarks. The outline view of the
						browser allows to browse large folder structures efficiently and you can quickly preview files with Quick Look. To edit files, a seamless integration with several external
						editors makes it easy to change content quickly. Both Amazon CloudFront and Cloud Files from Rackspace can be easily configured to distribute your content in the cloud. Many
						OS X core system technologies such as Spotlight, Bonjour and the Keychain are supported and a large number of translations makes you feel at home.</p>
						...
						"mailto:%66%65%65%64%62%61%63%6B%40%63%79%62%65%72%64%75%63%6B%2E%63%68">feedback</a> you might have. For bug reports and feature suggestions you should issue a <a class="ext"
						href="http://trac.cyberduck.ch/newticket">new ticket</a> in the <a class="ext" href="http://trac.cyberduck.ch">issue tracker</a>.</p>
						...
						<div id="features">
							<div class="feature">
								...
								"ext">WebDAV</a></span> (Web-based Distributed Authoring and Versioning), <span class="version3"><a class="ext" href="http://aws.amazon.com/s3">Amazon S3</a></span>
								and <a class="ext" href="http://www.rackspacecloud.com/cloud_hosting_products/files">Rackspace Cloud Files</a>.</p>
								...
								"http://macromates.com/">TextMate</a>, <a class="ext" href="http://www.tex-edit.com/">Text-Edit Plus</a>, <a class="ext" href="http://mimikaki.net/">mi</a>, <a class=
								"ext" href="http://smultron.sourceforge.net/">Smultron</a>, <a class="ext" href="http://macrabbit.com/cssedit/">CSSEdit</a>, <a class="ext" href=
								"http://www.aynimac.com/">CotEditor</a>, <a class="ext" href="http://www.talacia.com/">Tag</a>, <a class="ext" href="http://skti.org/skedit/">skEdit</a> and <a class=
								"ext" href="http://www.hogbaysoftware.com/products/writeroom">WriteRoom</a> and <a class="ext" href="http://code.google.com/p/macvim/">MacVim</a> and <a class="ext"
								href="http://forgedit.com/">ForgEdit</a> and <a class="ext" href="http://www.artman21.net/product/JeditX/">JeditX</a>, <a class="ext" href=
								...
								<!--Available in English, Czech, Dutch, Finnish, French, German, Italian, Japanese, Korean, Norwegian, Portuguese, Slovak, Spanish, Chinese (Traditional &amp; Simplified Han), Russian, Swedish, Hungarian, Danish, Polish, Indonesian, Catalan, Welsh, Thai, Turkish, Hebrew, Latvian and Greek.<br />-->
								 English, čeština, Nederlands, Suomi, Français, Deutsch, Italiano, 日本語, 한국어, Norsk, Slovenčina, Español, Português (do Brasil), Português (Europeu), 中文 (简体), 正體中文
								(繁體), Русский, Svenska, Dansk, Język Polski, Magyar, Bahasa Indonesia, Català, Cymraeg, ภาษาไทย, Türkçe, Ivrit, Latviešu Valoda &amp; Ελληνικά</p>

								<p><img src="./img/keychain.png" class="feature" alt="" /> <strong>Keychain</strong><br />
								All passwords are stored in the system <a class="ext" href="http://www.apple.com/macosx/features/security/">Keychain</a> as Internet passwords available also to third
							...
							<div class="feature">
								...
								Limit the number of concurrent transfers and filter files using a regular expression. Resume both interrupted download and uploads. Recursively transfer
								directories.</p>
							...
							<div class="feature">
								...
								Supports Public key authentication, Keyboard Interactive (PAM) Authentication, Support for various encryption ciphers (3DES, Blowfish, Twofish, AES, CAST) and
								...
								"http://faq.gmx.de/datenverwaltung/mc/index.html">Mediacenter</a>, Microsoft SharePoint or any other <a href="http://webdav.org" class="ext">WebDAV</a> compliant
								server. Supports Basic, Digest and NTLM Authentication.</p>

								<p><img src="./img/cf.png" class="feature" alt="" /> <strong class="version3">Rackspace Cloud Files</strong><br />
								Manage your Rackspace <a class="ext" href="http://www.rackspacecloud.com/cloud_hosting_products/files">Cloud Files</a> storage including the configuration of your
								<a href="http://www.rackspacecloud.com/cloud_hosting_products/files/limelight">Limelight Content Distribution</a>.</p>
						...
						"http://creativecommons.org/licenses/GPL/2.0/">GNU General Public License</a> as published by the Free Software Foundation; either version 2 of the License, or (at your
						option) any later version.<em>This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or
						FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.</em></small></p>

						<p><small>This product includes software developed by <strong>Duncan McGregor et al.</strong> (<a class="ext" href="https://rococoa.dev.java.net/">Rococoa</a>),
						<strong>Timothy Wall et al.</strong> (<a class="ext" href="https://jna.dev.java.net/">JNA</a>), <strong>Christian Plattner</strong> (<a class="ext" href=
						"http://www.ganymed.ethz.ch/ssh2/">Ganymed</a>), <strong>enterprisedt</strong> (<a class="ext" href="http://www.enterprisedt.com">enterprisedt.com</a>) and the <strong>Apache
						Software Foundation</strong> (<a class="ext" href="http://jakarta.apache.org">jakarta.apache.org</a>), <strong>James Murty</strong> (<a class="ext" href=
						"http://jets3t.s3.amazonaws.com/index.html">jetS3t</a>), <strong>Christopher Forsythe et al.</strong> (<a class="ext" href="http://growl.info/">growl.info</a>), <strong>M. Uli
						Kusterer</strong> (<a class="ext" href="http://zathras.de/">UKCrashReporter and UKPrefsPanel</a>), <strong>Greg Guerin</strong> (<a class="ext" href=
						...
						"http://extendmac.com/EMKeychain/">EMKeychain</a>), <strong>Lucas Newman</strong> (<a class="ext" href="http://www.aquaticmac.com/">AquaticPrime</a>)</small></p>
					</div>
				</td>
				...
				<td id="sidebar">
						...
						<div class="box-shadow">
							<div id="download">
								<div style="float:left">
									...
									<em>Nov-13-2009</em><br />
									<a href="Cyberduck-3.3.zip">Cyberduck-3.3.zip</a><br />
									Universal Binary<br />
									Mac OS X 10.5<br />
									or later required.
								</div>
								...
								<div style="float:right">
									<a href="Cyberduck-3.3.zip"><img src="./img/zip.png" align="left" alt="Download" border="0" width="128px" /></a>
								</div>
							</div>
					...
					<div class="box-solid">
						<p><img class="feature" src="./img/feed-icon-16x16.png" alt="feed" /> <strong>Blog.</strong> <a href="http://sudo.ch/feed/">Subscribe</a> to the the developer's <a class="ext"
						href="http://sudo.ch/">blog</a> or <a href="http://twitter.com/davidkocher">follow @davidkocher on twitter</a>.</p>
					</div>
