		...
		<table cellpadding="0" cellspacing="5">
			<tr>
				<td id="maincolumn" valign="top" class="box-dash">
					<p><strong style="color:#7b7b7b;">Cyberduck is a
					<a class="ext-link" href=
					"http://opensource.org/docs/definition.php">open
					source</a> FTP and SFTP (SSH Secure File Transfer)
					browser licenced under the GPL with an easy to use
					interface, integration with external editors and
					support for many Mac OS X system technologies such
					as Spotlight, Bonjour, the Keychain and
					AppleScript.</strong> For a more detailed list of
					available <strong>features</strong> see <a href=
					"./features.php">here</a>.
					...
					Polish, Indonesian, Catalan and Welsh</em>. Many
					thanks to all <a class="ext-link" href=
					"http://trac.cyberduck.ch/file/trunk/Credits.html?format=raw">
					contributors</a>! If you need <strong>help</strong>,
					there is an <a href=
					"./help/en/howto">introduction</a> and a list of
					<a href="./help/en/problems/">known problems</a>.
					Please post any questions on the <strong><a class=
					"ext-link" href="./forum">forum</a></strong> if the
					<a href="./help/en/faq">FAQ</a> doesn't cover them.
					This software is written by <a class="ext-link"
					href="http://sudo.ch/">David V. Kocher</a>. Please
					have a look at the <a class="ext-link" href=
					"http://trac.cyberduck.ch/file/trunk/Credits.html?format=raw">
					credits</a> to see who contributed. I appreciate any
					<strong><a class="ext-link" href=
					"mailto:feedback@cyberduck.ch">feedback</a></strong>
					you might have. For bug reports and feature
					suggestions you should issue a <a class="ext-link"
					href="http://trac.cyberduck.ch/newticket">new
					...
					align="center" id="screenshot">
						...
						"middle" border="0" src="./img/browser-thumb.jpg"
						alt="Cyberduck Screenshot" /></a>
					</div>

					<p><small>Copyright (c) 2002-2005 David V. Kocher.
					All rights reserved. This program is free software;
					you can redistribute it and/or modify it under the
					terms of the <a href="License.txt">GNU General
					Public License</a> as published by the Free Software
					Foundation; either version 2 of the License, or (at
					your option) any later version.<em>This program is
					distributed in the hope that it will be useful, but
					WITHOUT ANY WARRANTY; without even the implied
					warranty of MERCHANTABILITY or FITNESS FOR A
					PARTICULAR PURPOSE. See the GNU General Public
					License for more details.</em></small></p>

					<p>This product includes software developed by
					<strong>sshtools.com</strong> (<a class="ext-link"
					href=
					"http://www.sshtools.com">http://www.sshtools.com</a>),
					<strong>enterprisedt</strong> (<a class="ext-link"
					href=
					...
					"ext-link" href=
					"http://apple.com/">http://apple.com</a>).</p>
				</td>

				<td id="sidebar" valign="top">
					<div class="box-dash">
						<p><em>"All the other FTP clients I've used have
						been hard to learn and are confusing, but I've
						never had to look at the help file for
						Cyberduck."</em> <a href=
						...
						<div style="margin:5px;" align="center">
							...
							<img src="./img/macworld.png" width="90"
					...
					<div class="box-solid">
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td valign="top"><img width="64" height=
								"90" style="margin:10px; margin-top:-5px"
								src="./img/arrowdisk.png" align="left" alt=
								"Download" border="0" /></td>

								<td valign="top">
									<p><strong>2.5.3</strong>
									<em>(Jan-04-2006)</em><br />
									<a href=
									"./Cyberduck-2.5.3.dmg">Cyberduck-2.5.3.dmg</a>
									<a href=
									"./Cyberduck-2.5.3.dmg"></a><br />
					...
					<div class="box-filled">
						<p><strong>Donations.</strong> <em><a class=
						"ext-link" href=
						"http://www.gnu.org/philosophy/free-sw.html">Free
						software</a> is a matter of the users freedom to
						run, copy, distribute, study, change and improve
						the software. If you find this program useful,
						please consider making a <a href=
						"./donate">donation</a>. It will help to make
						Cyberduck even better!</em></p>
					</div>
					...
					<div class="box-filled">
						...
						<p>Email: <input id="mailinglist" type="text"
						name="email" value="" /> <input type="submit"
						name="email-button" value="Subscribe" /></p>
						</form>
					</div>
					...
					<div class="box-filled">
						...
						<div style="margin-top:-10px; margin-bottom:5px;" align="center">
							<a href="http://forum.cyberduck.ch"><img width="128" src=
							"./img/cocoaforge.png" alt="forum" /></a>
						</div>
					</div>
					...
					<div class="box-filled">
						...
						"http://sudo.ch/~dkocher/feed/">Subscribe</a> to
						the the developer's <a class="ext-link" href=
						"http://sudo.ch/~dkocher/">blog</a>.</p>
					</div>

					<div style="margin-bottom:0px;" class="box-filled">
						<p><a href="http://quicksilver.blacktree.com">
						<img class="sidebar" src="./img/quicksilver.png"
...
<strong>Quicksilver Module.</strong> Access
						...
						<p>
													<a href="http://growl.info"><img height="64" class="sidebar" src=
							"./img/growlicon.png" alt="getgrowl" /></a>

						<strong>Growl.</strong> You may also want to
						install <a class="ext-link" href=
						"http://growl.info">Growl</a>, a global
						notification system Cyberduck supports.</p>

						<p><strong>RCDefaultApp.</strong> Set Cyberduck
						as the default application for all FTP URLs with
						<a class="ext-link" href=
