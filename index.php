...
/*<![CDATA[*/
 ...
 a.c2 {color: #ffffff; font-weight: bold;}
    ...
    <table border="0" cellpadding="5" cellspacing="5" width="700">
      ...
      <tr>
        <td width="150" class="box-filled">
          <div class="c1">
            <a href="./donate"><img border="0" src=
            "http://www.paypal.com/en_US/i/btn/x-click-but04.gif"
            alt=
            "Make payments with PayPal - it's fast, free and secure!" /></a>
          </div>
        </td>

        <td colspan="2" class="alert">Support the development of
        Cyberduck by making a <a class="c2" href=
        "./donate">donation</a> :)</td>
      ...
      <tr>
        <td width="150" valign="middle" class="box-solid">
          ...
          <p>Go shopping for Cyberduck gadgets in the <a href=
          "http://www.cafeshops.com/cyberduck">Cafepress Cyberduck
          shop</a>!</p>
        </td>
