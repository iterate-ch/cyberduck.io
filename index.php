                ...
                <small>This product includes software developed by <strong>Christian Plattner</strong> (<a class="ext"
                    ...
                    <strong>M. Uli Kusterer</strong> (<a class="ext" href="http://zathras.de/">UKCrashReporter and
                        ...
                        Matuschak</strong> (<a class="ext" href=
                            "http://www.andymatuschak.org/pages/sparkle">Sparkle</a>), <strong>Kurt Revis</strong> (<a
                            class="ext" href="http://www.snoize.com/">SNDisclosableView</a>), <strong>Shaun
                        Wexler</strong> (<a href="http://www.macfoh.com/">SKWSegmentedControl</a>),
                </small>
            </p>
        </td>
                ...
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td id="download" valign="top">
                            <a href="./Cyberduck-3.1.2.dmg"><img style="margin:15px; margin-top:0px" src="./img/arrowdisk.png"
                        ...
                        <td valign="top">
                            <p>
                                ...
                                <a href="./Cyberduck-3.1.2.dmg">Cyberduck-3.1.2.dmg</a><br/>(10.3MB, Mac OS X 10.4 or later
                                required.)
                                <?php echo(echodonate(".")); ?>
                            </p>
                        </td>
