						...
						<table cellpadding="0" cellspacing="0">
							...
							<tr>
								<td width="150" valign="top">
									...
									<a href="http://update.cyberduck.ch/beta/Cyberduck-3.3b1.zip">Download</a><br />
									<br />
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<li>[Feature] UTF8 charset negogiation [<a href="http://tools.ietf.org/html/draft-ietf-ftpext-utf-8-option-00">draft-ietf-ftpext-utf-8-option-00</a>]
										(FTP)</li>

										<li>[Feature] Support for directory listings using MLSD [<a href="http://tools.ietf.org/html/rfc3659">RFC 3659</a>] (FTP)</li>

										<li>[Feature] Support for Modification Time (MFMT) extension [<a href="http://tools.ietf.org/html/draft-somers-ftp-mfxx-04">draft-somers-ftp-mfxx-04</a>]
										(FTP)</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<li>[Feature] Default transfer setting for regular expression of skipped files includes GIT and others [<a href=
										"http://trac.cyberduck.ch/ticket/2829">#2829</a>]</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<li>[Feature] Support for faster directory listings using STAT command on the control connection (FTP) [<a href=
										"http://trac.cyberduck.ch/ticket/683">#683</a>]</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										<li>[Feature] Added Taco HTML Edit to the list of supported editors (<a href="http://tacosw.com/htmledit/beta.php">http://tacosw.com/htmledit/beta.php</a>)
										[<a href="http://trac.cyberduck.ch/ticket/188">#188</a>]</li>
										...
										<li>[Bugfix] External editor failures [<a href="http://trac.cyberduck.ch/ticket/2041">#2041</a>, <a href="http://trac.cyberduck.ch/ticket/2039">#2039</a>,
										<a href="http://trac.cyberduck.ch/ticket/2052">#2052</a>, <a href="http://trac.cyberduck.ch/ticket/2058">#2058</a>]</li>
							...
							<tr>
								<td width="150" valign="top">
									...
									<a href="http://update.cyberduck.ch/Cyberduck-3.0b1.dmg">Download</a><br />
									<br />
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<li>[Feature] Toolbar button to open Terminal.app SSH session in current working directory (SFTP) [<a href=
										"http://trac.cyberduck.ch/ticket/1508">#1508</a>]</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<strong>Warning! Make sure your setting in <i>System Preferences → Network → Use Passive FTP Mode (PASV)</i> is checked to get the same default setting as in
										previous versions.</strong></li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<li>[Feature] Option to remember open browser windows and reconnect upon relaunching the application [<a href=
										"http://trac.cyberduck.ch/ticket/59">#59</a>]</li>
										...
										<li>[Bugfix] Folders marked as inaccessible after timeouts and cannot be opened after reconnecting [<a href=
										"http://trac.cyberduck.ch/ticket/611">#611</a>]</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<li>[Bugfix] Removed graphical error messages for the sake of simplicity; displayed in log drawer instead [<a href=
										"http://trac.cyberduck.ch/ticket/524">#524</a>, <a href="http://trac.cyberduck.ch/ticket/580">#580</a>]</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<li>[Bugfix] Character encoding issues [<a href="http://trac.cyberduck.ch/ticket/238">#238</a>, <a href="http://trac.cyberduck.ch/ticket/333">#333</a>,
										<a href="http://trac.cyberduck.ch/ticket/361">#361</a>, <a href="http://trac.cyberduck.ch/ticket/390">#390</a>]</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										"http://trac.cyberduck.ch/ticket/96">#96</a>, <a href="http://trac.cyberduck.ch/ticket/121">#121</a>, <a href=
										"http://trac.cyberduck.ch/ticket/122">#122</a>)</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										<li>[Feature] FTP using TLS support (using AUTH TLS as in draft-murray-auth-ftp-ssl-16) for the control channel (sending login credentials) and optionally the
										data channel (file listings and transfers) if the server is capable of.</li>
							...
							<tr>
								...
								<td colspan="2">
									<ul>
										...
										<li>[Feature] Cyberduck can now be configured as the default FTP helper application. See <a href=
										"http://www.monkeyfood.com/software/moreInternet/">monkeyfood.com</a>. This seems to work with Safari and Internet Explorer.</li>
