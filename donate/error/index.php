			...
			<div id="teaser">
				...
				<div class="box-shadow">
					...
					<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
						<input type="hidden" name="cmd" value="_s-xclick" /><input type="hidden" name="hosted_button_id" value="4914397" /><input type="image" src="../../img/donate.gif" name="submit" alt="PayPal - The safer, easier way to pay online!" /><img alt="" src=
