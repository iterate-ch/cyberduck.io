...
<body id="swing" bgcolor="#FFFFFF">
    <div align="center" class="standard">
        <table border="0" cellpadding="5" cellspacing="5" width="700">
            ...
            <tr>
                <td colspan="2"></td>
                <td class="alert">This version of Cyberduck is <strong>outdated</strong>. Please have a look at the <a href="./index.php">new version</a> written with the Cocoa Framework and with support for SSH.</td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td bgcolor="#FFFFFF" class="box-dash">
                    ...
                    <p>i appreciate any comments, feature suggestions and bug reports. please send them directly to <a href="mailto:dkocher@icu.unizh.ch?subject=cyberduck%20comment">me.</a></p>
                </td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td class="box-solid"><a name="features" id="features">features</a></td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td bgcolor="#FFFFFF" class="box-dash">
            ...
            <tr>
                <td colspan="2"></td>
                <td class="box-solid"><a name="requirements" id="requirements">requirements</a></td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td bgcolor="#FFFFFF" class="box-dash">
                    <table width="100%" border="0">
                        <tr>
                            <td>
                                ...
                                cyberduck has not been tested with jdk 1.4.<br /></p>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="2"></td>
                <td class="box-solid"><a name="download" id="download">download</a></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"></td>
                <td class="box-solid"><a name="code" id="code">source code</a></td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td bgcolor="#FFFFFF" class="box-dash">
            ...
            <tr>
                <td colspan="2"></td>
                <td class="box-solid"><a name="history" id="history">version history</a></td>
            </tr>
            <tr>
                <td colspan="2"></td>
                <td bgcolor="#FFFFFF" class="box-dash">
