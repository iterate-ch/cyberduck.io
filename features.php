...
<body id="features">
  ...
  <div id="content">
    <div class="feature">
      ...
      paste, drag &amp; drop and arbitrary character encodings.</p>

      <p><img src="./img/advanced.png" class="feature" alt="" />
      <strong>International</strong><br />
      Available in <em>English, Czech, Dutch, Finnish, French,
      German, Italian, Japanese, Korean, Norwegian, Portuguese,
      Slovak, Spanish, Chinese (Traditional and Simplified),
      Russian, Swedish, Hungarian, Danish, Polish, Indonesian and
      Catalan</em>.</p>
    ...
    <div class="feature">
      ...
      Powerful bookmarking in a the browser drawer. Drag and drop
      bookmarks to the Finder.app and drop files onto bookmarks to
      upload.</p>
    ...
    <div class="feature">
      ...
      Synchronize local with remote directories (and vice versa)
      and get a preview of affected files before any action is
      taken.</p>
      ...
      Supports Public key authentication, Keyboard Interactive
      (PAM) Authentication, Support for various encryption ciphers
