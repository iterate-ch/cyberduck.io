      ...
      <tr>
        <td class="box-dash">
          <div class="feature">
            ...
            FTP (File Transfer Protocol), FTP/TLS (FTP secured over
            SSL/TLS) and SFTP (SSH Secure File Transfer).</p>

            <p><img src="./img/column.png" class="feature" alt=
            "" /> <strong>Browser</strong><br />
            Document based, list and outline view, caching, cut
            ...
            <a class="ext-link" href=
            "http://www.tex-edit.com/">Text-Edit Plus</a>,
            <a class="ext-link" href=
            "http://macromates.com/">TextMate</a>, <a class=
            "ext-link" href="http://mimikaki.net/">mi</a>,
            <a class="ext-link" href=
            ...
            "ext-link" href="http://www.aynimac.com/">CotEditor</a>
            and <a class="ext-link" href=
          ...
          <div class="feature">
            ...
            <p><img src="./img/document.png" class="feature" alt=
            "" /> <strong>Bookmarking</strong><br />
            Powerful bookmarking in a the browser drawer. Drag and
            drop bookmarks to the Finder.app and drop files onto
            bookmarks to upload.</p>

            <p><img src="./img/rendezvous.png" class="feature" alt=
            "" /> <strong>Bonjour</strong><br />
            Auto discovery of services on the local network</p>

            <p><img src="./img/finder.png" class="feature" alt=
            "" /> <strong>Integration</strong><br />
            Use Cyberduck as default system wide protocol handler
            for FTP (Requires <a class="ext-link" href=
            ...
            "" /> <strong>Resumable Transfers</strong><br />
            Both download and upload.</p>

            <p><img src="./img/advanced.png" class="feature" alt=
            "" /> <strong>Recursive Transfers.</strong><br />
            Both download and upload.</p>

            <p><img src="./img/applescript.png" class="feature"
            alt="" /> <strong>AppleScript</strong><br />
            Full AppleScript integration. See the <a class=
            "ext-link" href=
          ...
          <div class="feature">
            ...
            All passwords are stored in the system <a class=
            "ext-link" href=
            ...
            Synchronize local with remote directories (and vice
            versa) and get a preview of affected files before any
            action is taken.</p>
            ...
            <p><img src="./img/sftp.png" class="feature" alt="" />
            <strong>SSH</strong><br />
            Supports Public key authentication, Keyboard
            Interactive (PAM) Authentication, Support for various
            encryption ciphers (3DES, Blowfish, Twofish, AES, CAST)
