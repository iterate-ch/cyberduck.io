    ...
    <div align="center" class="standard">
        <table border="0" cellpadding="5" cellspacing="5" width="700">
            ...
            <tr>
                ...
                <td valign="middle"><img src="./img/browse.png" alt="Browse" border="0" /></td>
            ...
            <tr>
                <td class="box-filled" valign="top"><strong>Bookmarking</strong></td>
                <td valign="top" colspan="2" class="box-dash">
                    <ul>
                    ...
                    <div align="center">
                        <img src="./img/spotlight.jpg" height="64" alt="Spotlight" border="0" /> <img src="./img/document.jpg" height="64" alt="Document" border="0" /> <img src="./img/idisk.jpg" height="64" alt="iDisk" border="0" />
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="box-filled" valign="top"><strong>Keychain support</strong></td>
                <td valign="top" colspan="2" class="box-dash">
                    <ul>
